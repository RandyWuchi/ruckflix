...
export const selectActionAdventureSeries = (state) =>
  state.series.actionAdventureSeries;
...
export const selectDocumentarySeries = (state) =>
  state.series.documentarySeries;
